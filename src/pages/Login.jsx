...
export default function Login() {
  ...
  // THE FIX: The conflicting useEffect has been removed from here.
  // The RequireAuth component now handles this logic correctly.
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEmail("");
      setPassword("");
      // This will now work correctly, navigating to the intended page (e.g., /assignment/...)
        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4">
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 to-violet-500 hover:from-violet-500 hover:to-blue-500 
